...
namespace MAction.BaseClasses.Exceptions
{
    public abstract class CustomApplicationException : Exception
    {
        ...
        public CustomApplicationException(Exception exception = null, Exception innerException = null, string message = null, string serviceName = null, string userName = null, int? userId = null, int? code = null, string tenant = null, Dictionary<string, List<string>> errors = null, string projectName = null)
